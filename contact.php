...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat|Permanent+Marker|Luckiest+Guy" rel="stylesheet">
...
<body class="black_bg">
    ...
    <!-- formulaire de contact = impression d'écrire une lettre -->
